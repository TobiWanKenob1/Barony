...
FMOD_RESULT F_CALL pcmreadcallback(FMOD_SOUND* sound, void* data, unsigned int datalen) //mod edit: FMOD update
{
...
FMOD_RESULT F_CALL ensembleExplorationCallback(FMOD_CHANNELCONTROL* channelcontrol, //mod edit
	FMOD_CHANNELCONTROL_TYPE controltype,
	FMOD_CHANNELCONTROL_CALLBACK_TYPE callbacktype,
	void* commanddata1,
	void* commanddata2);

FMOD_RESULT F_CALL ensembleCombatCallback(FMOD_CHANNELCONTROL* channelcontrol, //mod edit
	FMOD_CHANNELCONTROL_TYPE controltype,
	FMOD_CHANNELCONTROL_CALLBACK_TYPE callbacktype,
	void* commanddata1,
	void* commanddata2);
